...
* [HTTP 基本概念](#http-基本概念)
  * [HTTP是什么](#http是什么)
  * [HTTP常见的状态码有哪些](#http常见的状态码有哪些)
  * [HTTP常见字段有哪些](#http常见字段有哪些)
* [Get 与 Post](#get-与-post)
  * [Get和Post有哪些区别](#get和post有哪些区别)
  * [Get和Post方法都是安全和幂等的吗](#get和post方法都是安全和幂等的吗)
* [HTTP 特性](#http-特性)
  * [Http有哪些优点](#http有哪些优点)
  * [Http有哪些缺点](#http有哪些缺点)
  * [Http的性能如何](#http的性能如何)
* [HTTPS 与 HTTP](#https-与-http)
  * [Http与Https有那些区别](#http与https有那些区别)
  * [HTTPS 解决了 HTTP 的哪些问题？](#https-解决了-http-的哪些问题)
  * [](#)
  * [HTTPS 是如何解决上面的三个风险的？(重点)](#https-是如何解决上面的三个风险的重点)
...
![1631800934230](.images/1631800934230.png)
...
+ `Connection` :字段最常用于客户端要求服务器使用 TCP 持久连接，以便其他请求复用。
  ![1631801288228](.images/1631801288228.png)
...
![1631802340213](.images/1631802340213.png)
...
![1631802425762](.images/1631802425762.png)
...
## HTTPS 是如何解决上面的三个风险的？(重点)

我们先要了解下什么是[对称加密和非对称加密](对称加密和非对称加密.md)
...
![image-20220329185852570](.images/image-20220329185852570.png)
