...
* [传统的 System Call I/O](#传统的-system-call-io)
  * [读操作](#读操作)
  * [写操作](#写操作)
  * [网络 I/O](#网络-io)
  * [磁盘 I/O](#磁盘-io)
* [高性能优化的 I/O](#高性能优化的-io)
* [存储设备的 I/O 栈](#存储设备的-io-栈)
* [I/O Buffering](#io-buffering)
* [参考资料](#参考资料)
...
![](.images/下载-1636113328333.png)

 ##  磁盘 I/O

![](.images/下载-1636113379834.png)
...
https://mp.weixin.qq.com/s/iRfq1Xs_0Ia3-OUmTpyKuw
